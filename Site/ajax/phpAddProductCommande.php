<?php 
	...
	echo '<br><br><div class="form-group">
	    	...
	    	<div class="col-sm-10">
				<select class="form-control" name="produit' . $_SESSION["NoLigneProduit"] . '" size="1" id="produit">
		...
		<div class="form-group">
		    ...
		    <input type="text" name="quantite' . $_SESSION["NoLigneProduit"] . '" class="form-control" id="quantite" placeholder="Quantité">
		</div>';

		$amount = 1;
		$_SESSION["NoLigneProduit"] += $amount;
?>